...
#Группа: ЦИБ-251
#Здание: Домен: IT-услуги ; Дочерние классы 1 (Наследуют БК 1): Consulting (консультант),Development (язык прог.) ; Дочерний класс 2 (Наследует БК 2): CorporateClient (корп. скидка) ;
#Контейнер: Project ; Полиморфный метод (Бизнес-логика) : calculate_cost(hours) (у консалтинга мин. 5 часов)
